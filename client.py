...
from model.FedCI import FedCI as Network
...
def main(args):
    ...
    if args.mode == 'train':
        ...
        model.load_state_dict(torch.load(f'/data/zm/FedCIM/checkpoints/{args.dataset}_{args.in_steps}_{args.out_steps}_{args.cid}.pth',  map_location='cuda:0'))
...
if __name__ == "__main__":
    ...
    args.add_argument('--tod_embedding_dim', default=config['data']['tod_embedding_dim'], type=int)
    args.add_argument('--dow_embedding_dim', default=config['data']['dow_embedding_dim'], type=int)
    args.add_argument('--num_nodes', default=config['data']['num_nodes'], type=int)
    args.add_argument('--dsp', default=config['data']['dsp'], type=int)
    args.add_argument('--dsu', default=config['data']['dsu'], type=int)
